...
> 状态：M1 至 M7 已完成；首批 22 产品 v1.0 及 31 产品正式扩围验收通过
>
> 更新日期：2026-08-20
>
> 依据：当前对话中已经确认的范围和规则
...
项目首先支持 22 个产品、44 个处理项，并在 Complex 页面修复验收后正式扩围至 31 个产品、62 个处理项。冻结项目的代码、运行产物和支持状态只能作为参考；新代码不得导入或修改 `ACNArchaeologist-rewrite/` 之外的旧实现。
